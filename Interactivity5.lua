...
new = function ( params )
	...
	local function prepareWelcomeScreen()
		...
		local titleLabel = display.newText( "Help mary to go to sleep", 0, 0, mainFont1, 36 )
	...
	local function prepareTransition()
		...
		startTransition = function(shouldRepeat)
			...
			transition.to(star1,{xScale=3,time=1500,transition=easing.inExpo})
			transition.to(star2,{xScale=2.5,time=1500,transition=easing.inExpo})
			transition.to(star3,{xScale=2,time=1500,transition=easing.inExpo})
			transition.to(star4,{xScale=3.5,time=1500,transition=easing.inExpo})
			
			transition.to(star1,{yScale=3,time=1500,transition=easing.inExpo})
			transition.to(star2,{yScale=2.5,time=1500,transition=easing.inExpo})
			transition.to(star3,{yScale=2,time=1500,transition=easing.inExpo})
			transition.to(star4,{yScale=3.5,time=1500,transition=easing.inExpo})
